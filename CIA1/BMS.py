...
def british_museum_search(graph, start, goal):
    ...
    while queue:
        node, path, current_cost = queue.pop(0)
...
if __name__ == "__main__":
    ...
    path, cost = british_museum_search(graph, start_vertex, goal_vertex)
    save_result_to_file(path, cost, result_file, "British Museum Search")
